          ...
          <div className="flex flex-col space-y-1.5 ">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Select a new empty folder or select an existing folder that will
                contain your notes.
              </p>
            </div>
          </div>
          <div className="mt-4">
            {isSupported ? (
                ...
                <p className="text-red-700 text-sm italic">
                    This browser does not support file access at this time. 
                    Please use a compatible browser (Google Chrome, Microsoft Edge, or Opera).
                </p>
            )}
          </div>
        </div>
